 ...
 * @author admin
 */
@WebServlet(name = "CinemaStatisticServlet", urlPatterns = {"/admin/CinemaStatisticServlet"})
public class CinemaStatisticServlet extends HttpServlet {
private JDBCUtility jdbcUtility;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        response.sendRedirect(request.getContextPath() + "/admin/MovieStatisticServlet");
    }
